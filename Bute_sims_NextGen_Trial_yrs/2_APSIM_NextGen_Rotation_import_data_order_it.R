...
APSIM_NextGen <- read_excel("X:/Riskwi$e/Bute/3_Sims_post_Nov2024/Bute_5_Rotation_N_bank_v3.xlsx", 
...
write.csv(APSIM_NextGen ,
          "X:/Riskwi$e/Bute/3_Sims_post_Nov2024/results/APSIM_NextGen.csv", row.names = FALSE )
