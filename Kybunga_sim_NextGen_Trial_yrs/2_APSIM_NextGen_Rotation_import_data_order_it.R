...
APSIM_NextGen_daily <- read_excel("X:/Riskwi$e/Kybunga/3_Sims_post_Nov2024/Kybunga_5_Rotation_N_bank.xlsx", 
                            sheet = "DailyReport")
...
write.csv(APSIM_NextGen_daily ,
          "X:/Riskwi$e/Kybunga/3_Sims_post_Nov2024/Results/APSIM_NextGen_Daily.csv", row.names = FALSE )
