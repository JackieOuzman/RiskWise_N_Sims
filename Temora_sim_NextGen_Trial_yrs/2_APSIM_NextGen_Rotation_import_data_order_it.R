...
APSIM_NextGen_daily <- read_excel("X:/Riskwi$e/Temora/3_Sims_post_Nov2024/Temora_5_Rotation_N_bank.xlsx", 
                            sheet = "DailyReport")
...
APSIM_NextGen_daily <- APSIM_NextGen_daily %>% mutate(
  Treatment = case_when(
    ...
    Treatment == "3_YP Lite_Decile 1" ~              "YP_Decile_1",
    Treatment == "4_YP Lite_Decile 2_3" ~            "YP_Decile_2_3",
    Treatment == "5_YP Lite_Decile 5" ~              "YP_Decile_5",
    Treatment == "6_YP Lite_Decile 7_8" ~            "YP_Decile_7_8",
    Treatment == "7_YP Lite_BOM" ~                   "YP_BOM",
    Treatment == "8_N_Bank_Less_Optimum" ~           "N_Bank_Less_Optimum",
    Treatment == "9_N_Bank_Profit" ~                 "N_Bank_Profit",
...
write.csv(APSIM_NextGen_daily ,
          "X:/Riskwi$e/Temora/3_Sims_post_Nov2024/Results/APSIM_NextGen_Daily.csv", row.names = FALSE )
