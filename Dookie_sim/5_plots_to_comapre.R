...
# Plot --------------------------------------------------------------------
Location_of_Sims<- "X:/Riskwi$e/Dookie/2_Sims_post_Sep2024/"
NextG_location <- "2_NextGen/Dookie_5_Rotation_N_bank.apsimx"
Classic_Location <- "1_Classic/Operation_schedule/3_operation schedule.apsim"


#"X:\Riskwi$e\Dookie\2_Sims_post_Sep2024\1_Classic\Operation_schedule\3_operation schedule.apsim"
#"X:\Riskwi$e\Dookie\2_Sims_post_Sep2024\1_Classic\Dookie_Rotation\4_Dookie_rotation.apsim"
#"X:\Riskwi$e\Dookie\2_Sims_post_Sep2024\2_NextGen\Dookie_5_Rotation_N_bank.apsimx"
...
sowing_dates <-  trial_data %>%
  ...
  mutate(Date = case_when(
    Date == "2022-11-10" ~ "2022-04-15",
    Date == "2023-11-23" ~ "2023-05-04"
  ))
