...
# ggsave(plot = plot2,
#        filename = paste0(path_saved_files,"/FloweringJulianDays_vs_yiled_Kyancutta_v2", ".png" ),
#        width = 20, height = 12, units = "cm")
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/NOFROSTBox_yield_vs_drySowing_datesKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot3_box,
       filename = paste0(path_saved_files,"/NOFROST_RuleBox_yield_vs_germination_datesKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot4_box,
       filename = paste0(path_saved_files,"/NO Frost Box_yield_vs_germination_dates_count_coloursKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
