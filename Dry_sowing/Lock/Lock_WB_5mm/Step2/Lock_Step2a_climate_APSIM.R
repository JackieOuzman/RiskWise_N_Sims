...
Lock_Daily_APSIM <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/APSIM_runs/Lock_Water_balance_v5 WB_5mm.Daily.csv", 
...
write.csv(Lock_APSIM_Met_gs ,
          "X:/Riskwi$e/Dry_sowing/Lock/Results/WB_5mm/WB_5mmDry_sowing_Lock_factor_with_met_18046_v2_gs.csv", row.names = FALSE )
...
write_csv(summary_frost_details,
          file = paste0(path_saved_files,"/WB_5mm_summary_frost_details_Lock_v2", ".csv"))
