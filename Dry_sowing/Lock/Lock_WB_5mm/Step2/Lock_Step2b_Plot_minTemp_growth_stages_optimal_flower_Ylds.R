...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_drySowing_datesLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
plot3_box <- Yld_germination_date %>% 
  ...
  ylim(0,6)+
  labs(title = "Yield vs germination dates Lock 18046. \nOptimal germination conditions using water balance with threshold of 5mm",
...
ggsave(plot = plot3_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_germination_datesLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot4_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_germination_dates_count_coloursLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
