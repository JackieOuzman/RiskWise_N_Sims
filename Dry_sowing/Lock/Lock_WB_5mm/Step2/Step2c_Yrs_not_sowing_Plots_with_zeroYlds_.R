...
Dry_sowing_Lock_factor_with_met <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/Results/WB_5mm/WB_5mmDry_sowing_Lock_factor_with_met_18046_v2_gs.csv")
...
years_germ
################################################################################
path_saved_files <- file_path_input_data<-file.path("X:","Riskwi$e", "Dry_sowing", "Lock", "Results", "WB_5mm")
ggsave(plot = years_germ,
       filename = paste0(path_saved_files,"/years_Optimal germination conditions was triggered Lock", ".png" ),
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_drySowing_dates_dummy_zero_ylds_Lock", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot3_mean_yld,
       filename = paste0(path_saved_files,"/mean_yield_vs_drySowing_dates_dummy_zero_ylds_Lock", ".png" ),
       width = 20, height = 12, units = "cm")
