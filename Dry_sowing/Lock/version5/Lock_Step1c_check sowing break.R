...
write.csv(climate ,
          "X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version5/Results/NeatClimate_18046.csv", row.names = FALSE )
                       

climate2022_23_24 <- climate %>% 
  filter(year %in% c(2022, 2023, 2024))
climate2014_to_2024 <- climate %>% 
  filter(year %in% c(2014,2015,2016,2017,2018,2019, 2020, 2021, 2022, 2023, 2024))

write.csv(climate2022_23_24 ,
          "X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version5/Results/NeatClimate_18046_yrs2022_23_24.csv", row.names = FALSE )

write.csv(climate2014_to_2024 ,
          "X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version5/Results/NeatClimate_18046_yrs2014_to_2024.csv", row.names = FALSE )
