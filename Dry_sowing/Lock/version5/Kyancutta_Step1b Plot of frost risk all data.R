...
path_saved_files
ggsave(plot = plot1,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_GS", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot1_2015_2024,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_GS_2014_2024", ".png" ),
       width = 20, height = 12, units = "cm")



ggsave(plot = plot2_perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_GS_Prec", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot2_2015_2024perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_GS_2014_2024_Prec", ".png" ),
       width = 20, height = 12, units = "cm")



write_csv(summary_frost_details_all_yrs,
          file = paste0(path_saved_files,"/summary_frost_details_Kyancutta_Std_GS", ".csv"))
