...
met_frost <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version5/Results/Fost_details_18170.csv")
str(met_frost)
...
## Define the FR period and assign season type ---------------------------------
...
plot1 <- summary_frost_details_all_yrs %>% 
  ...
  labs(title = "Frost Risk at Kyancutta climate station number 18170",
...
plot2_perc <- summary_frost_details_all_yrs %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 90, hjust = 1))+
  labs(title = "Frost Risk at Kyancutta climate station number 18170",
       subtitle = paste0("Standard FR of ", unique(days_FR$days_FR)," days, defined as ", FR_defined_as),
       x = "years",
...
plot2_2015_2024perc <- summary_frost_details_all_yrs %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 90, hjust = 1))+
  labs(title = "Frost Risk at Kyancutta climate station number 18170",
       subtitle = "Period of frost risk of 214 day. 1/4 to 1/11",
       x = "years",
       y = "Percentage of days classified as frost (< 1)"
  )
plot2_2015_2024perc
...
path_saved_files
ggsave(plot = plot1,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_FR", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot1_2015_2024,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_FR_2014_2024", ".png" ),
       width = 20, height = 12, units = "cm")



ggsave(plot = plot2_perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_FR_Prec", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot2_2015_2024perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Kyancutta_std_FR_2014_2024_Prec", ".png" ),
       width = 20, height = 12, units = "cm")
