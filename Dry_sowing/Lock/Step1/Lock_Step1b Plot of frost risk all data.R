...
path_saved_files
ggsave(plot = plot1,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Lock_std_FR", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot1_2015_2024,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Lock_std_FR_2014_2024", ".png" ),
       width = 20, height = 12, units = "cm")



ggsave(plot = plot2_perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Lock_std_FR_Prec", ".png" ),
       width = 20, height = 12, units = "cm")


ggsave(plot = plot2_2015_2024perc,
       filename = paste0(path_saved_files,"/Climate_Frost_days_Lock_std_FR_2014_2024_Prec", ".png" ),
       width = 20, height = 12, units = "cm")



write_csv(summary_frost_details_all_yrs,
          file = paste0(path_saved_files,"/summary_frost_details_Lock_Std_FR", ".csv"))
...
plot3_2015_2024temperature <- climate_long %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 90, hjust = 1))+
  labs(title = "Min and Max temperature per day in the frost period station number 18046",
