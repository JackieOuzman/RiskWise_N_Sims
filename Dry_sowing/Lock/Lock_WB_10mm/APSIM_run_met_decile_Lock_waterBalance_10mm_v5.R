...
Quantile_sow_date_decile <- Quantile_sow_date_decile %>% 
  mutate(site ="Lock_18046",
        ...
        APSIM_sow_rule = "water balance TH 10mm") %>% 
...
write_csv(Quantile_sow_date_decile, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Lock/for_Decile_cal/Lock_WB_10mm", 
                       "/APSIM_yld_Decile_waterBalnce_TB10mm_Lock18046", ".csv"))
