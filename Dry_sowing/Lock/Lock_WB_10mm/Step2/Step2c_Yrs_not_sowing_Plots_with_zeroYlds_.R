...
Dry_sowing_Lock_factor_with_met <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/Results/WB_10mm/WB_10mmDry_sowing_Lock_factor_with_met_18046_v2_gs.csv")
...
years_germ <- sowing_germination_event_trigger %>% 
  ...
  labs(title = "Count of years when Optimal germination conditions was triggered. ",
       subtitle = "Lock 18046. \nUsing water balance with threshold of 10mm",
