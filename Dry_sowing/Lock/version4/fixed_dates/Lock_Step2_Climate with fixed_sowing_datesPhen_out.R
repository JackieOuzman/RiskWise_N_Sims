...
Dry_sowing_Lock_factor <- Fixed_dates_factor_phen_dates_v3 <- read_excel("X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version4_fixed_dates/fixed_dates_factor_phen_dates_v4.xlsx", 
