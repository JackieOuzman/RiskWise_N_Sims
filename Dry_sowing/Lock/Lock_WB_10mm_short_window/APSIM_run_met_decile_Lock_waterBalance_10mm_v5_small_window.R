...
write_csv(Quantile_sow_date_decile, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Lock/for_Decile_cal/Lock_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_waterBalnce_TB10mm_Lock18046_small_window", ".csv"))
...
write_csv(Yld_Dry_sowing_Lock_factor_with_met_decile_summary_germ_date, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Lock/for_Decile_cal/Lock_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_GermDate_waterBalnce_TB10mm_Lock18046_No_summary_small_window", ".csv"))
...
write_csv(Yld_Dry_sowing_Lock_factor_with_met_decile_summary_germ_date, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Lock/for_Decile_cal/Lock_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_GermDate_waterBalnce_TB10mm_Lock18046_No_summary", ".csv"))
