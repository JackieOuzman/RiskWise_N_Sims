...
# ggsave(plot = plot1,
#        filename = paste0(path_saved_files,"/MinTemp_vs_days_growthStages_Lock2023_v2", ".png" ),
...
plot2 <- Yld_flowering %>% 
  ...
  theme_classic()+
  theme(legend.position = "none")+
  labs(title = "Yield vs flowering dates Lock 18046. 5 days windows.",
...
ggsave(plot = plot2,
       filename = paste0(path_saved_files,"/Sort_window_FloweringJulianDays_vs_yiled_Lock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
plot2_box <- Yld_flowering %>% 
  ...
  ylim(0,6)+
  labs(title = "Yield vs dry sowing dates Lock 18046. **5 days windows**.\nOptimal germination conditions using water balance with threshold of 10mm",
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Short_window_Box_yield_vs_drySowing_datesLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
distinct(Dry_sowing_Lock_factor_with_met,Wheat.Phenology.CurrentStageName )
germination_dates <- Dry_sowing_Lock_factor_with_met %>% 
...
plot3_box <- Yld_germination_date %>% 
  ...
  ylim(0,6)+
  labs(title = "Yield vs germination dates Lock 18046.**5 day window** \nOptimal germination conditions using water balance with threshold of 10mm",
...
ggsave(plot = plot3_box,
       filename = paste0(path_saved_files,"/Short_window_Box_yield_vs_germination_datesLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
plot4_box <- Yld_germination_date %>% 
  ...
  ylim(0,6)+
  labs(title = "Yield vs germination dates Lock 18046.**5 days window** \nOptimal germination conditions using water balance with threshold of 10mm",
       subtitle = "Years when germination date falls inside date window on x axis\nIf optimal germination conditions are not met no gernimation will occur and no yield will be produced.",
       y = "Yield t/ha",
       x ="Date range when germination occured"
...
ggsave(plot = plot4_box,
       filename = paste0(path_saved_files,"/Short_windowBox_yield_vs_germination_dates_count_coloursLock_v2", ".png" ),
       width = 20, height = 12, units = "cm")
