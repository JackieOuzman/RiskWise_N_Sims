...
#Lock_Water_balance_v5 10mm fixed.Daily
met_frost <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/Results/Fost_details_18046.csv")
str(met_frost)

# Download Daily APSIM output -------------------------------------------------------
Lock_Daily_APSIM <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/APSIM_runs/Lock_Water_balance_v5 WB_10mm fixed.Daily.csv", 
...
Lock_Daily_APSIM <- sowing_window_retain %>% 
...
write.csv(Lock_APSIM_Met_gs ,
          "X:/Riskwi$e/Dry_sowing/Lock/Results/short_window_10mm/Short_window_Dry_sowing_Lock_factor_with_met_18046_v2_gs.csv", row.names = FALSE )
...
path_saved_files
ggsave(plot = plot1,
       filename = paste0(path_saved_files,"/Short_window_Climate_Frost_days_Lock_v2", ".png" ),
       width = 20, height = 12, units = "cm")

ggsave(plot = plot2,
       filename = paste0(path_saved_files,"/Short_window_Climate_Frost_days_Lock_10-May_v2", ".png" ),
       width = 20, height = 12, units = "cm")

write_csv(summary_frost_details,
          file = paste0(path_saved_files,"/Short_window_summary_frost_details_Lock_v2", ".csv"))
