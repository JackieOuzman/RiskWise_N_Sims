...
Dry_sowing_Lock_factor <- Fixed_dates_factor_phen_dates_v3 <- read_excel("X:/Riskwi$e/Dry_sowing/Lock/Dry_sowing/version3_fixed_dates/Fixed_dates_factor_phen_dates_v3.xlsx", 
