...
#Lock_Water_balance_v5 5mm fixed.Daily
met_frost <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/Results/Fost_details_18046.csv")
str(met_frost)

# Download Daily APSIM output -------------------------------------------------------
Lock_Daily_APSIM <- read_csv("X:/Riskwi$e/Dry_sowing/Lock/APSIM_runs/Lock_Water_balance_v5 WB_5mm fixed.Daily.csv", 
...
write.csv(Lock_APSIM_Met_gs ,
          "X:/Riskwi$e/Dry_sowing/Lock/Results/short_window_5mm/Short_window_Dry_sowing_Lock_factor_with_met_18046_v2_gs.csv", row.names = FALSE )
