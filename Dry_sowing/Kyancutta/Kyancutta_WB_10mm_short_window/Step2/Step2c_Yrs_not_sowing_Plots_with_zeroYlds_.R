...
ggsave(plot = years_germ,
       filename = paste0(path_saved_files,"/Short_window_years_Optimal germination conditions was triggered Kyancutta", ".png" ),
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Small_window_Box_yield_vs_drySowing_dates_dummy_zero_ylds_Kyancutta", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot3_mean_yld,
       filename = paste0(path_saved_files,"/Small_window_mean_yield_vs_drySowing_dates_dummy_zero_ylds_Kyancutta", ".png" ),
       width = 20, height = 12, units = "cm")
