...
Kyancutta_Daily_APSIM <- read_csv("X:/Riskwi$e/Dry_sowing/Kyancutta/APSIM_runs/Kyancutta_Water_balance_v5 10mm fixed.Daily.csv", 
...
write.csv(Kyancutta_APSIM_Met_gs ,
          "X:/Riskwi$e/Dry_sowing/Kyancutta/Results/short_window_10mm/Short_window_Dry_sowing_Kyancutta_factor_with_met_18170_v2_gs.csv", row.names = FALSE )
