...
plot2
path_saved_files <- file_path_input_data<-file.path("X:","Riskwi$e", "Dry_sowing", "Kyancutta", "Results", "short_window_10mm")
ggsave(plot = plot2,
       filename = paste0(path_saved_files,"/Sort_window_FloweringJulianDays_vs_yiled_Kyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Short_window_Box_yield_vs_drySowing_datesKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot3_box,
       filename = paste0(path_saved_files,"/Short_window_Box_yield_vs_germination_datesKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot4_box,
       filename = paste0(path_saved_files,"/Short_windowBox_yield_vs_germination_dates_count_coloursKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
