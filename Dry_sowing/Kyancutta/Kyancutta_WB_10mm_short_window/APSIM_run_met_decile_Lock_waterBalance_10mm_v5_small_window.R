...
Dry_sowing_Kyancutta_factor_with_met <- read_csv("X:/Riskwi$e/Dry_sowing/Kyancutta/Results/short_window_10mm/Short_window_Dry_sowing_Kyancutta_factor_with_met_18170_v2_gs.csv")
...
Dry_sowing_Kyancutta_factor_with_met_decile <- left_join(Dry_sowing_Kyancutta_factor_with_met, Decile_18170, by = "year")
str(Dry_sowing_Kyancutta_factor_with_met_decile)


## side step add germination to one data files
germination_date <- Dry_sowing_Kyancutta_factor_with_met_decile %>% 
...
Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary <- Dry_sowing_Kyancutta_factor_with_met_decile %>% 
...
Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date <- left_join(
  Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary, germination_date)


## cal some stats for each decile what is the bottom 10% quantile 

Quantile_sow_date_decile <- Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary %>% 
...
Quantile_sow_date_decile <- Quantile_sow_date_decile %>% 
  mutate(site ="Kyancutta_18170",
        Yrs_included_decile =  "1957 to 2024",
        GS_def_decile = "1/4 to 1/11",
        APSIM_sow_rule = "water balance TH 10mm 5day window") %>% 
...
write_csv(Quantile_sow_date_decile, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Kyancutta/for_Decile_cal/Kyancutta_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_waterBalnce_TB10mm_Kyancutta18170_small_window", ".csv"))
...
str(Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date)
Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date <- Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date %>% 
...
write_csv(Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Kyancutta/for_Decile_cal/Kyancutta_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_GermDate_waterBalnce_TB10mm_Kyancutta18170_No_summary_small_window", ".csv"))


### force germination date into 'windows'
Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date
...
Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date$germination_between <- factor(Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date$germination_between , ordered = TRUE, 
                                                   levels = c(
                                                     "1 to 5 Apr",
                                                     "5 to 10 Apr",
                                                     "10 to 15 Apr",
...
write_csv(Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Kyancutta/for_Decile_cal/Kyancutta_WB_10mm_small_window", 
                       "/APSIM_yld_Decile_GermDate_waterBalnce_TB10mm_Kyancutta18170_No_summary", ".csv"))
