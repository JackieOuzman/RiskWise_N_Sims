...
Dry_sowing_Kyancutta_factor_with_met <- read_csv("X:/Riskwi$e/Dry_sowing/Kyancutta/Results/short_window_5mm/Short_window_Dry_sowing_Kyancutta_factor_with_met_18170_v2_gs.csv")
...
write_csv(Quantile_sow_date_decile, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Kyancutta/for_Decile_cal/Kyancutta_WB_5mm_small_window", 
                       "/APSIM_yld_Decile_waterBalnce_TB5mm_Kyancutta18170_small_window", ".csv"))
...
write_csv(Yld_Dry_sowing_Kyancutta_factor_with_met_decile_summary_germ_date, 
          file =paste0("X:/Riskwi$e/Dry_sowing/Kyancutta/for_Decile_cal/Kyancutta_WB_5mm_small_window", 
                       "/APSIM_yld_Decile_GermDate_waterBalnce_TB5mm_Kyancutta18170_No_summary_small_window", ".csv"))
