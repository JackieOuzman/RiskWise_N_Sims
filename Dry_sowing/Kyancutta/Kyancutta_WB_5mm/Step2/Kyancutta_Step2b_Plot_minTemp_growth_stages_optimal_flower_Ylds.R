...
plot2 <- Yld_flowering %>% 
  ...
  theme_classic()+
  theme(legend.position = "none")+
  labs(title = "Yield vs flowering dates Kyancutta 18170",
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_drySowing_datesKyancutta_v2", ".png" ),
       width = 20, height = 12, units = "cm")
...
plot3_box <- Yld_germination_date %>% 
  ...
  ylim(0,6)+
  labs(title = "Yield vs germination dates Kyancutta 18170. \nOptimal germination conditions using water balance with threshold of 5mm",
