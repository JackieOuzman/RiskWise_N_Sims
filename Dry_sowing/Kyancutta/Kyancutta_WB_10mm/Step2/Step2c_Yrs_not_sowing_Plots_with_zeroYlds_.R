...
ggsave(plot = years_germ,
       filename = paste0(path_saved_files,"/WB10_years_Optimal germination conditions was triggered Kyancutta", ".png" ),
...
ggsave(plot = plot2_box,
       filename = paste0(path_saved_files,"/WB10_Box_yield_vs_drySowing_dates_dummy_zero_ylds_Kyancutta", ".png" ),
       width = 20, height = 12, units = "cm")
